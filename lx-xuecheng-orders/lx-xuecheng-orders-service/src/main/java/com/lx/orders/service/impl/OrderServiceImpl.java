package com.lx.orders.service.impl;
...
import com.lx.base.utils.IdWorkerUtils;
import com.lx.base.utils.QRCodeUtil;
import com.lx.message.model.entity.MqMessage;
import com.lx.message.service.MqMessageService;
import com.lx.orders.config.AlipayConfig;
import com.lx.orders.config.PayNotifyConfig;
import com.lx.orders.mapper.XcOrdersGoodsMapper;
import com.lx.orders.mapper.XcOrdersMapper;
import com.lx.orders.mapper.XcPayRecordMapper;
import com.lx.orders.model.dto.AddOrderDto;
import com.lx.orders.model.dto.PayRecordDto;
import com.lx.orders.model.dto.PayStatusDto;
import com.lx.orders.model.entity.XcOrders;
import com.lx.orders.model.entity.XcOrdersGoods;
import com.lx.orders.model.entity.XcPayRecord;
import com.lx.orders.service.OrderService;
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        try {
            ...
            if(!response.isSuccess()){//交易不成功
                XueChengException.cast("请求支付宝查询支付结果失败");
            }
            body = response.getBody();
        } catch (AlipayApiException e) {
            e.printStackTrace();
            XueChengException.cast("请求支付查询支付结果异常");
        }
